...
<link rel="stylesheet" href="Layout/assets/css/styleuser.css">
                    ...
                    <div class="box">
						...
						<div class="account">
                            ...
                            <div class="col-8 col-sm-12">
                                ...
                                <div class="box16">
                                    <a href="?pg=detail&id=<?=$yt["id_phim"]?>">
                                        <figure>
      ...
      <li class="page-item <?= ($page <= 1) ? 'disabled' : '' ?> ">
        <a class="page-link" href="?pg=bosuutap&page=<?= $page - 1 ?>" aria-label="Previous">
          <span aria-hidden="true">&laquo;</span>
        </a>
      </li>
      <?php for ($i = 1; $i <= $sotrang2; $i++) : ?>
        <li class="page-item <?= ($page == $i) ? 'active' : '' ?>"><a class="page-link " href="?pg=bosuutap&page=<?= $i ?>"><?= $i ?></a></li>
      <?php endfor; ?>
      <li class="page-item <?= ($page >= $sotrang2) ? 'disabled' : '' ?> ">
        <a class="page-link" href="?pg=bosuutap&page=<?= $page + 1 ?>" aria-label="Next">
